...
class Semantic3D:
    def __init__(self):
        ...
        self.path = '/home/data/semantic3d'
    ...
    def get_tf_mapping(self):
        ...
        def tf_map(batch_xyz, batch_features, batch_labels, batch_pc_idx, batch_cloud_idx):
            ...
            batch_graph_idx = tf.py_func(DP.knn_search, [input_points[0], input_points[0], cfg.k_n], tf.int32)
            input_list = input_points + input_neighbors + input_pools + input_up_samples
            input_list += [batch_features, batch_labels, batch_pc_idx, batch_cloud_idx, batch_graph_idx]
    ...
    def tf_augment_input(inputs):
        ...
        # Create N x 3 vector of scales to multiply with stacked points
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='train', help='options: train, test, val')
